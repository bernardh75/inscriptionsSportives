...
public class ispanelcompet extends ispanelnopage implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == validercreation) {
			...
			try {
	            ...
	            System.out.println("La compétition, " + nomCompet + " a été créée avec succés");
			} catch (ParseException e1) {
				System.out.println("Le format de la date est le suivant : 'yyyy-mm-dd' ! " + e1);
			}
		}
