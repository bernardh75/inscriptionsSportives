...
public class ispanelpersonne extends ispanelnopage implements ActionListener{
	...
	protected JLabel labelValidation;
	
	
	public ispanelpersonne() {
		super(1);
	...
	public void editerSportif() {
		...
		labelValidation = new JLabel("Le sportif a été bien édité");
