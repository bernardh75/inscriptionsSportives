...
public class ispanelequipe extends ispanelnopage implements ActionListener{
	...
	public ispanelequipe() {
	    ...
	    selectionner = new JButton("Sélectionner une Equipe");
	...
	public void selectionnerEquipe() {
		...
		test.add(new JLabel("Sélectionner une Equipe"));
		test.add(list);
	...
	public void ajouterEquipe() {
		...
		test.add(new JLabel("Sélectionner le Joueur à ajouter"));
		test.add(list2);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == valider) {
			...
			System.out.println("L'équipe, " + nomEquipe + " a été créée avec succés");
			text.setText("");
		}
